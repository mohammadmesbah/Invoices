                ...
                <form action="/Search_customers" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-sm-1 col-md-1">
                            <button class="btn btn-primary btn-block mb-2">بحث</button>
                        </div>
                    </div>
                </form>
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ url('invoice_details') }}/{{ $invoice->id }}">{{ $invoice->section->name }}</a>
                                        </td>
                                        ...
                                        <td>
                                            @if ($invoice->value_status == 1)
                                                <span class="badge rounded-pill bg-success">{{ $invoice->status }}</span>
                                            @elseif($invoice->value_status == 2)
                                                <span class="badge rounded-pill bg-danger">{{ $invoice->status }}</span>
                                            @else
                                                <span class="badge rounded-pill bg-warning">{{ $invoice->status }}</span>
                                            @endif
