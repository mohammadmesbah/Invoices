				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='partial_paid_invoices') }}">الفواتير المدفوعة جزئيا</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='ArchiveInvoices') }}">أرشيف الفواتير</a></li>
						</ul>
					</li>
					{{-- <li class="slide"> 
