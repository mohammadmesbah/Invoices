								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="markAllAsRead">تعين كمقروءة</a></span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="notification_count">لديك {{auth()->user()->unreadNotifications->count()}} إشعارات غير مقروءة</p>
									</div>
									<div class="main-notification-list Notification-scroll" id="unReadNotification">
										
										@foreach (auth()->user()->unReadNotifications as $notification)	
										<a class="d-flex p-3 border-bottom" href="{{url('invoice_details')}}/{{$notification->data['invoice_id']}}">
